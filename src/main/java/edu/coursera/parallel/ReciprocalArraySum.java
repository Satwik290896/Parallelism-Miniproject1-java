...
public final class ReciprocalArraySum {
    ...
    private static class ReciprocalArraySumTask extends RecursiveAction {
        ...
        protected void compute() {
            // TODO
        	//double sum = 0;
        	int SEQ_THRESH = input.length/200;
    ...
    protected static double parManyTaskArraySum(final double[] input,
        ...
        for (int i = 0; i < numTasks; i++) {
            int pi = getChunkStartInclusive(i, numTasks, input.length);
            int pe = getChunkEndExclusive(i, numTasks, input.length);
            ReciprocalArraySumTask t = new ReciprocalArraySumTask(pi, pe, input);
        	tasks.add(t);
        }
